...
class Class_Info
{
	...
	public function __toString()
	{
		...
		$output .= "<table style=\"font-size:14px\"><tr><th></th><th class=\"c_title\">Class</th><th>Instructor</th><th>Credits</th><th>Details</th><th>Enrollments</th></tr>";
		foreach($this->classes as $key => $value)
		{
			$bool = 1;
			$output .= "<tr><td><img src=\"../Images/icon_small_plus.gif\" class=\"expand\"/></td><td class=\"c_title\">" . $key . "</td><td>" . $value['teacher'] . "</td><td>" . $value['credits']
				. "</td><td>" . $value['details'] . "</td><td class=\"c_enroll\">" . $value['enroll'] . "</td></tr>";
