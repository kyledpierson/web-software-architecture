...
<div id="wrapper">
  ...
  <ul>
	...
	else
	{
		...
		<a href=\"register.php\"><li id=\"register\">Set Up An Account</li></a>";
	}
	?>
...
<div id="main">
  <p id = "message">  <?php if(isset($message)){echo $message; unset($message);} ?> </p>
  <p>This the home page for the TA Application website.  Please login in or create an account to continue</p>
</div>
